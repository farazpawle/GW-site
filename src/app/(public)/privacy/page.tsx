...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: page?.metaDesc || page?.description || 'Privacy Policy for Garrit & Wulf Auto Parts.',
  };
}
...
export default async function PrivacyPage() {
  const page = await getCached(
    ...
    300 // Cache for 5 minutes (rarely updated content)
  );
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-3 gap-6 mb-16">
              ...
              >
                ...
                <h3 className="text-lg font-bold mb-2 text-white">Data Protection</h3>
                <p className="text-gray-400 text-sm leading-relaxed">
                  Your information is secured with industry-standard encryption and protection measures.
                </p>
              </div>
              ...
              >
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  We are clear about what data we collect and how we use it for your benefit.
                </p>
              </div>
              ...
              >
                ...
                <h3 className="text-lg font-bold mb-2 text-white">Your Rights</h3>
                <p className="text-gray-400 text-sm leading-relaxed">
                  You have full control over your personal information and can request changes anytime.
                </p>
              </div>
            </div>
          </div>
