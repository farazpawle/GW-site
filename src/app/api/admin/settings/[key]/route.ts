...
export async function PUT(
  ...
  try {
    ...
    // Clear cache after successful setting update
    try {
      await clearPattern('homepage:*');
      await clearPattern('settings:*');
      console.log('[Cache] Cleared homepage and settings cache after settings update');
    } catch (cacheError) {
      console.error('[Cache] Failed to clear cache after settings update:', cacheError);
