    ...
    <>
      {visibleSections.map((section) => {
        switch (section.sectionType) {
          case 'hero':
            return <HeroSection key={section.id} config={section.config as HeroSectionConfig} />;
          
          case 'brandStory':
            return <BrandStorySection key={section.id} config={section.config as BrandStorySectionConfig} />;
          
          case 'carousel':
            return <BrandCarouselSection key={section.id} config={section.config as CarouselSectionConfig} />;
          
          case 'categories':
            return <CategoriesSection key={section.id} config={section.config as CategoriesSectionConfig} />;
          
          case 'precisionMfg':
            return <PrecisionManufacturingSection key={section.id} config={section.config as PrecisionMfgSectionConfig} />;
