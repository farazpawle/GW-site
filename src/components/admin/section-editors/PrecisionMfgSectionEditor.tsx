...
export default function PrecisionMfgSectionEditor({ section, isOpen, onClose, onSave }: PrecisionMfgSectionEditorProps) {
  ...
  const openMediaPicker = (serviceIndex: number) => {
  ...
  const handleMediaSelect = (file: MediaFile) => {
    if (selectedServiceIndex !== null) {
      const newServices = [...config.services];
      newServices[selectedServiceIndex].image = file.url;
        ...
        <div className="space-y-4 p-4 bg-[#0a0a0a] rounded-lg border border-[#2a2a2a]">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g., Our Services, Manufacturing Capabilities"
              maxLength={100}
        ...
        <div className="space-y-4 p-4 bg-[#0a0a0a] rounded-lg border border-[#2a2a2a]">
          ...
          <div>
            ...
            >
              ...
              <option value="ghost">Ghost - Transparent with hover</option>
            </select>
          </div>
