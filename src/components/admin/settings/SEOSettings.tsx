      ...
      <div>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            >
              Meta Keywords
              <span className="ml-2 px-2 py-0.5 text-xs bg-yellow-900/30 text-yellow-400 rounded border border-yellow-700">
                Low Impact
              </span>
            </label>
            <input
              ...
              placeholder="auto parts, European parts, American parts, premium automotive"
              className="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white focus:ring-2 focus:ring-maroon-500 focus:border-transparent"
            />
            <p className="mt-1 text-xs text-gray-400">
              ⚠️ Comma-separated keywords. Note: Most search engines (Google,
              Bing) ignore meta keywords. Focus on quality content and proper
      ...
      <div className="pt-4 border-t border-gray-700">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            />
            <p className="mt-1 text-xs text-gray-400">
              Image shown when your site is shared on social media (recommended:
              1200x630px)
            </p>
      ...
      <div className="pt-4 border-t border-gray-700">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-gray-400">
              ...
              <span className="font-mono">G-XXXXXXXXXX</span> | Universal
              Analytics: <span className="font-mono">UA-XXXXXXXX-X</span>
            </p>
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onChange("google_tag_manager_id", e.target.value)
              }
              placeholder="GTM-XXXXXXX"
              className="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white focus:ring-2 focus:ring-maroon-500 focus:border-transparent font-mono text-sm"
            />
            <p className="mt-1 text-xs text-gray-400">
              Format: <span className="font-mono">GTM-XXXXXXX</span> (found in
              your GTM container settings)
            </p>
          </div>
        </div>
        ...
        <div className="mt-4 p-4 bg-blue-900/20 border border-blue-700/30 rounded-lg">
          ...
          <ul className="text-xs text-blue-300/90 space-y-1 ml-5 list-disc">
            <li>
              Keep title under 60 characters for optimal display in search
              results
            </li>
            <li>
              Meta description should be 150-160 characters for best appearance
            </li>
            <li>
              OG image should be 1200x630px for proper social media display
            </li>
        ...
        <div className="mt-4 p-4 bg-green-900/20 border border-green-700/30 rounded-lg">
          ...
          <ul className="text-xs text-green-300/90 space-y-1 ml-5 list-disc">
            <li>
              Analytics scripts automatically injected when IDs are provided
            </li>
            <li>GA4 and GTM will load on all pages after saving</li>
            <li>
              Scripts use Next.js Script component with proper loading strategy
            </li>
