    ...
    <footer className="relative overflow-hidden" style={{ backgroundColor: '#0a0a0a' }}>
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        ...
        <div className="flex justify-center mb-16">
          ...
          >
            <Image 
              src="/images/egh_member_200x.avif"
              alt="Economic Group Holdings"
              width={200}
              height={50}
              className="mx-auto"
            />
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 group">
                ...
                <div>
                  <p className="text-gray-400 text-sm leading-relaxed">
                    Corporate Office: 26 6A Street<br />
              ...
              <div className="flex items-start gap-3 group">
                ...
                <div>
                  <a href="tel:+97142243851" className="text-gray-400 hover:text-white transition-colors">
                    +971 4 224 38 51
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 group">
                ...
                <div>
                  <a href="mailto:sales@garritwulf.com" className="text-gray-400 hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/terms" className="text-gray-400 hover:text-[#ff9999] transition-colors flex items-center gap-2 group">
                  <span className="w-1.5 h-1.5 rounded-full bg-gray-600 group-hover:bg-[#6e0000] transition-colors"></span>
                  Terms & Services
                </Link>
              </li>
        ...
        <div className="border-t border-[#2a2a2a] mt-8 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
            <p className="text-gray-400">
              Copyright © {new Date().getFullYear()} All Rights Reserved by Garrit & Wulf
            </p>
            <div className="flex gap-6">
              <Link href="/privacy" className="text-gray-400 hover:text-[#ff9999] transition-colors">
                Privacy Policy
              </Link>
              <Link href="/terms" className="text-gray-400 hover:text-[#ff9999] transition-colors">
                Terms of Service
              </Link>
              <p className="text-gray-400">
                Website Managed by <span className="text-[#6e0000]">FRZ</span>
              </p>
            </div>
          </div>
        </div>
