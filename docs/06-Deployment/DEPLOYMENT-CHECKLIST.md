...
- [ ] Copy `NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY` (pk*live*...)
- [ ] Copy `CLERK_SECRET_KEY` (sk*live*...)
...
- [ ] Copied webhook signing secret (whsec\_...)
...
- [ ] NEXT*PUBLIC_CLERK_PUBLISHABLE_KEY is pk_live*...
- [ ] CLERK*SECRET_KEY is sk_live*...
- [ ] CLERK*WEBHOOK_SECRET is whsec*...
...
- Check you're using pk*live* keys (not pk*test*)
